...
func (cfg *registry) PostLoad() error {
	...
	authority, username, password, token, tlsCert, tlsKey :=
		os.Getenv("XEOL_REGISTRY_AUTH_AUTHORITY"),
		os.Getenv("XEOL_REGISTRY_AUTH_USERNAME"),
		os.Getenv("XEOL_REGISTRY_AUTH_PASSWORD"),
		os.Getenv("XEOL_REGISTRY_AUTH_TOKEN"),
		os.Getenv("XEOL_REGISTRY_AUTH_TLS_CERT"),
		os.Getenv("XEOL_REGISTRY_AUTH_TLS_KEY")
