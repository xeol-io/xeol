...
snapshot_assets_count() {
  ...
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_linux_arm64.deb
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_linux_arm64.tar.gz
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_linux_amd64.rpm
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_darwin_arm64.tar.gz
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_linux_amd64.deb
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_linux_arm64.rpm
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_darwin_amd64.zip
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_windows_amd64.zip
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_darwin_arm64.zip
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_linux_amd64.tar.gz
  #  ../../snapshot/xeol_0.32.0-SNAPSHOT-e5e847a_darwin_amd64.tar.gz

  echo "$(find ../../snapshot -maxdepth 1 -type f | grep 'xeol_' | grep -v checksums | wc -l | tr -d '[:space:]')"
}
...
snapshot_assets_archive_count() {
  ...
  echo "$(find ../../snapshot -maxdepth 1  -type f | grep 'xeol_' | grep 'tar\|zip' | wc -l | tr -d '[:space:]')"
}
