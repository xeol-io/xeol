					...
					1: {
						{
							...
							URL:      mustUrl(url.Parse("http://localhost:5000/eol-db-v0.2.0+2020-6-12.tar.gz")),
							Version:  1,
					...
					2: {
						{
							...
							URL:      mustUrl(url.Parse("http://localhost:5000/eol-db-v1.1.0+2020-6-13.tar.gz")),
							Version:  2,
			...
			expected: Listing{
				Available: map[int][]ListingEntry{
					1: {
						{
							Built:    time.Date(2020, 06, 13, 17, 13, 13, 0, time.UTC),
							URL:      mustUrl(url.Parse("http://localhost:5000/eol-db_v1_2020-6-13.tar.gz")),
							Version:  1,
							Checksum: "sha256:dcd6a285c839a7c65939e20c251202912f64826be68609dfc6e48df7f853ddc8",
						},
						{
							Built:    time.Date(2020, 06, 12, 16, 12, 12, 0, time.UTC),
							URL:      mustUrl(url.Parse("http://localhost:5000/eol-db_v1_2020-6-12.tar.gz")),
							Version:  1,
							Checksum: "sha256:e20c251202948df7f853ddc812f64826bdcd6a285c839a7c65939e68609dfc6e",
						},
					},
