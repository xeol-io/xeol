...
// ValidateByHash takes in filesystem (fs), a file path (path), and a string representation of a hash (hashStr)
// and validates file at the given path has the expected hash value.
